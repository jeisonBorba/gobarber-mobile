...
const Profile: React.FC = () => {
  ...
  const oldPpasswordInputRef = useRef<TextInput>(null);
    ...
    ImagePicker.showImagePicker(
      ...
      (response) => {
        ...
        api
          ...
          .catch(() => Alert.alert('Error ao atualizar seu avatar.'));
      }
    );
  }, [user.id, updateUser]);
          ...
          <Container>
            ...
            <Form initialData={user} ref={formRef} onSubmit={handleSubmit}>
              ...
              <Input
                ...
                returnKeyType="next"
                onSubmitEditing={() => oldPpasswordInputRef.current?.focus()}
              />
              <Input
                ref={oldPpasswordInputRef}
                name="old_password"
                icon="lock"
